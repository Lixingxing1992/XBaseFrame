 ...
 * @author Lixingxing
 */
class TitleLayoutActivity : BaseActivity() {
    ...
    override fun initView() {
        titleLayout.setDefault("BaseTitleLayout控件列表")
            .setStatuBarView()
            .setRightText("setStatuBarPadding",View.OnClickListener {
                startActivity<TitleLayoutActivity2>()
                finish()
        })
        // 状态栏颜色或背景是否和标题一致
