...
import com.xx.base.org.superadapter.animation.AlphaInAnimation;
...
abstract class RecyclerSupportAdapter<T> extends RecyclerView.Adapter<SuperViewHolder>
    ...
    final String TAG = "BaseSuperAdapter";
    ...
    public int getItemViewType(int position) {
        ...
        if (isHeaderView(position)) {
            ...
            if (mMulItemViewType != null) {
                ...
                return mMulItemViewType.getItemViewType(position, position >= mData.size() ? null : mData.get(position));
            }
            return 0;
        }
        return viewType;
