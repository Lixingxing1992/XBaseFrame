...
import com.xx.base.org.tedpermission.util.ObjectUtils;
    ...
    public void check() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            for (String permission : instance.permissions ) {
                if (ContextCompat.checkSelfPermission(instance.context, permission) != PackageManager.PERMISSION_GRANTED) {
                    isNext = false;
